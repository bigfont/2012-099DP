<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="services.aspx.cs" Inherits="DavesBlasting.pages.skillsAndExperience" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainArticle" runat="server">
    ...
    <section>
        <h1>Concrete & Asphalt Cutting</h1>
        <div class="row-fluid">
            <div class="span12">
                <p>
    ...
    <section>
        <h1>Hand Digging up to Eight Feet
        </h1>
        <div class="row-fluid">
            <div class="span12">
                <p>
