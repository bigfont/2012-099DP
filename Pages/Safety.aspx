...
<asp:Content ID="Content4" ContentPlaceHolderID="cphHeader" runat="server">
    <h1><i class="icon-medkit">&nbsp;</i>Safety</h1>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainArticle" runat="server">
    <section>
        ...
        <ul class="icons-ul">
            ...
            <li><i class="icon-li icon-medkit"></i>All of our crew are
                ...
                certified.</li>
            <li><i class="icon-li icon-medkit"></i>(David Sly of Maple Leaf Powder provided our most recent
                <abbr title="Transportation of Dangerous Goods">TDG</abbr>
                course.)</li>
    ...
    <section>
        ...
        <ul class="icons-ul">
            <li><i class="icon-li icon-medkit"></i>We have had continuous coverage with WorkSafeBC since 1978. </li>
            <li><i class="icon-li icon-medkit"></i>And we are in excellent standing.</li>
            <li><i class="icon-li icon-medkit"></i>We have a clean, thirty-five year, third-party liability insurance record.</li>
        </ul>
    </section>
</asp:Content>
