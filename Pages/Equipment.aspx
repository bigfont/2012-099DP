...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainArticle" runat="server">
    <section>
        <ul class="thumbnails">
            <li class="span5">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-small-1.jpg" />
            ...
            <li class="span5 offset1">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-small-2.jpg" />
        ...
        <ul class="thumbnails">
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-medium-5.jpg" />
            ...
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-medium-2.jpg" />
        ...
        <ul class="thumbnails">
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-medium-3.jpg" />
            ...
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-medium-4.jpg" />
        ...
        <ul class="thumbnails">
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-medium-7.jpg" />
            ...
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-medium-1.jpg" />
        ...
        <ul class="thumbnails">
            <li class="span12">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-large-1.jpg" />
        ...
        <ul class="thumbnails">
            <li class="span12">
                <div class="thumbnail">
                    <img src="../assets-50/img/equipment-large-2.jpg" />
