...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainArticle" runat="server">
    <section>
        <ul class="thumbnails">
            <li class="span5">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-small-1.png" />
            ...
            <li class="span5 offset1">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-small-2.png" />
        ...
        <ul class="thumbnails">
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-medium-5.png" />
            ...
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-medium-2.png" />
        ...
        <ul class="thumbnails">
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-medium-3.png" />
            ...
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-medium-4.png" />
        ...
        <ul class="thumbnails">
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-medium-7.png" />
            ...
            <li class="span6">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-medium-1.png" />
        ...
        <ul class="thumbnails">
            <li class="span12">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-large-1.png" />
        ...
        <ul class="thumbnails">
            <li class="span12">
                <div class="thumbnail">
                    <img src="../assets-65/img/equipment-large-2.png" />
