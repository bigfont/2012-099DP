...
<asp:Content ID="Content4" ContentPlaceHolderID="cphHeader" runat="server">
    <h1><i class="icon-home">&nbsp;</i>Dave's Blasting
    </h1>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainArticle" runat="server">
    <section>
        <h1>Welcome</h1><h2><small>Dave's Blasting is a subsidiary of Blue Spruce Resources</small></h2>
        <p>
    ...
    <section>
        ...
        <p>
            ...
            extends through the Gulf Islands with occasional forays into Vancouver Island. Find out more about our <a href="../services">services</a>.
        </p>
    </section>
    <section>
        <h1>About</h1>
